...
const {HelloRequest, RepeatHelloRequest,
       HelloReply} = require('../proto/snake_pb.js');
const {GreeterClient} = require('../proto/snake_grpc_web_pb.js');
...
request.setId('jugador_'+playerId);
request.setName('Jugador '+playerId);

console.log("GetGameRoom", {id: playerId});
...
var streamRequest = new UpdateRequest();
